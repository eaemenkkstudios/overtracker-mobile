...
It's very easy to contribute. First, follow the instructions on the `Setting up` section of the [README](README.md#setting-up), but instead of just cloning the repository, [fork it](https://help.github.com/en/github/getting-started-with-github/fork-a-repo). 
